...
export default class Allmessage extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      //   nickname: JSON.parse(localStorage.getItem("userid")).user_id,
      nickname: localStorage.getItem("usernick"),
      //   userid: JSON.parse(localStorage.getItem("userid")).user_realid,
  ...
  componentWillMount() {
    // var user_realid = JSON.parse(localStorage.getItem("userid")).user_realid;
    var user_realid = localStorage.getItem("userid");
